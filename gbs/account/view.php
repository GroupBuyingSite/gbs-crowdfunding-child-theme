...
<div id="dashboard_container" class="dashboard_container clearfix">
	...
	<div id="account_settings_section" class="dash_section prime clearfix">
		<h2 class="section_heading contrast gb_ff"><?php gb_e('Your Account Settings'); ?> <a class="section_heading_link font_x_small" href="<?php gb_account_edit_url(); ?>"><?php gb_e('Edit'); ?></a></h2>
	...
	<div id="biz_section" class="dash_section prime clearfix">
		<h2 class="section_heading contrast gb_ff"><?php gb_e('Sponsor Account') ?> <?php if (gb_account_has_merchant()) { ?><a class="section_heading_link font_x_small"  href="<?php gb_merchant_edit_url(); ?>"><?php gb_e('Edit'); ?></a><?php } ?></h2>
		<?php if (gb_account_has_merchant()): ?>
			...
			<p><span class="contact_title"><?php gb_e('Sponsor Category:') ?></span> <?php echo gb_merchants_type_url(gb_account_merchant_id()); ?></p>
			...
			<p>
				<?php
					...
					if ( !empty($merchant->post_content) ) {
						?>
							<h3><?php gb_e('Your Sponsor Description'); ?></h3>
						<?php
		...
		<?php else: ?>
			<?php gb_e('Are you interested in sponsoring a project?') ?> <a class="header_edit_link" href="<?php gb_merchant_register_url(); ?>"><?php gb_e('Register now.'); ?></a>
		<?php endif ?>
	...
	<div class="dash_section prime">
		
		<h2 class="section_heading contrast gb_ff"><?php gb_e('My Backed Projects Overview'); ?> <a class="section_heading_link font_x_small"  href="<?php gb_voucher_url() ?>" title="<?php gb_e('Browse all my Deals'); ?>"><?php gb_e('See All&#63;'); ?></a></h2>
		...
		<?php
			...
			if ($vouchers->have_posts()) {
				...
				<table class="purchase_table vouchers_table gb_table purchases"><!-- Begin .gb_table -->
					...
					<thead>
						<tr>
							<th class="contrast purchase_deal_title th_voucher"><?php gb_e('Project'); ?></th>
							<th class="contrast th_status"><?php gb_e('Status'); ?></th>
							<th class="contrast th_voucher"><?php gb_e('Invoice'); ?></th>
